...
// ============================================================================
// Configuration - Disabled due to Manus migration
// ============================================================================

/**
 * Google Maps integration functionality has been disabled as part of the Manus migration.
 * This module previously proxied Google Maps API calls through the Manus Forge API.
 * If this functionality is required, a new implementation using a direct Google Maps API key
 * or another mapping provider will need to be developed.
 */
function getMapsConfig(): MapsConfig {
  throw new Error(
    "Google Maps integration is disabled. This relied on the Manus Forge API, which has been removed."
  );
}

// ============================================================================
// Core Request Handler - Disabled due to Manus migration
// ============================================================================
...
/**
 * Make authenticated requests to Google Maps APIs (DISABLED)
 * 
...
export async function makeRequest<T = unknown>(
  ...
  throw new Error(
    `Google Maps API request to "${endpoint}" is disabled. This functionality relied on the Manus Forge API, which has been removed. Please implement a new provider if this feature is required.`
  );
}
