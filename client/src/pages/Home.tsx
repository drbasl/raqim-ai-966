...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-20 md:pb-0">
      ...
      {/* Nano Banana Image Generator Section */}
      <section id="nano-banana-generator" className="py-12 sm:py-16 md:py-20 bg-gradient-to-b from-yellow-50/30 dark:from-slate-900/30 to-background">
        <div className="container">
