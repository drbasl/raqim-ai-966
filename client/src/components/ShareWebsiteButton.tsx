...
export default function ShareWebsiteButton({
  ...
  const handleTwitterShare = () => {
    const url = `https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(siteUrl)}&hashtags=رقيم_AI,AI,البرومبتات,السعودية`;
    window.open(url, "_blank");
  };
  ...
  return (
    <>
      ...
      >
        ...
        {t('generator.shareWebsite')}
      </Button>

      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-right">{t('share.title')}</DialogTitle>
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 rounded-lg bg-muted/50 text-sm text-muted-foreground">
              ...
              <p className="text-primary font-medium mt-2 break-all" dir="ltr">
                {siteUrl}
              </p>
            </div>
          </div>
